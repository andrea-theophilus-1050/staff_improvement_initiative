...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('qa-leaders.category.management') }}">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('qa-leaders.topics.management') }}">
                <i class="icon-grid menu-icon"></i>
        ...
        <li class="nav-item">
            <a class="nav-link" href="#">
                <i class="icon-grid menu-icon"></i>
                <span class="menu-title">QA Leaders roles</span>
            </a>
        </li>
        {{-- <li class="nav-item">
